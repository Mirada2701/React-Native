...
docker pull mirada032/pd211-asp-api:latest
docker ps -a
docker run -d --restart=always --name pd211-asp_container -p 4872:8080 mirada032/pd211-asp-api

docker run -d --restart=always -v /volumes/pd211-asp/images:/app/uploading --name pd211-asp_container -p 4872:8080 mirada032/pd211-asp-api
